...
{
	var unit_id     = "0";
	var client_ip   = "58.215.106.178";
	var server_time = "1298258745";
	var verify_code = "951cc048";
	var type        = "";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/0/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
