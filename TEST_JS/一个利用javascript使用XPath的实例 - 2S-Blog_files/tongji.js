...
{
	var unit_id     = "154655";
	var client_ip   = "58.215.106.189";
	var server_time = "1298337078";
	var verify_code = "c7a68e92";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/154655/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
